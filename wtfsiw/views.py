...
def index(request):
    ...
    # note that the user's location is passed to the browser, which then passes the address back to the server to populate the context for the Result template (to use localStorage)
